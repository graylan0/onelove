...
const DEFINE_PLUGIN = new webpack.DefinePlugin({
  ...
  'process.env.STEEMCONNECT_CLIENT_ID': JSON.stringify(
    process.env.STEEMCONNECT_CLIENT_ID || 'ipfsuploader.app',
  ),
  'process.env.STEEMCONNECT_REDIRECT_URL': JSON.stringify(
    process.env.STEEMCONNECT_REDIRECT_URL || 'https://portal.oneloveipfs.com/callback',
  ),
  'process.env.STEEMCONNECT_HOST': JSON.stringify(
    process.env.STEEMCONNECT_HOST || 'https://steemconnect.com',
  ),
  'process.env.STEEMJS_URL': JSON.stringify(process.env.STEEMJS_URL || 'https://techcoderx.com'),
  'process.env.SIGNUP_URL': JSON.stringify(process.env.SIGNUP_URL || 'https://oneloveipfs.com'),
