  ...
  static SLIDER_CONTENTS = [
    {
      ...
      defaultTitle: 'Find Friends In the Blockchain',
    ...
    },
    {
      ...
      defaultTitle: 'Decentralize Your Computing',
      className: 'HeroBannerSlider__image',
      number: 2,
    },
    {
      ...
      defaultTitle: 'Build a Community',
      className: 'HeroBannerSlider__image',
      number: 3,
    },
  ];
          ...
          <div className="HeroBanner__content-container">
            <div className="HeroBanner__content">
              <img
                ...
                alt="Find Friends In the Blockchain"
              />
              <div className="HeroBanner__content__description">
                ...
                <div className="HeroBanner__content__title">
                  <FormattedMessage
                    ...
                    defaultMessage="Find Friends In the Blockchain"
                  />
                </div>
              </div>
            </div>
            <div className="HeroBanner__content">
              <img
                ...
                className="HeroBanner__content__image"
                alt="Decentralize Your Computing"
              />
              <div className="HeroBanner__content__description">
                ...
                <div className="HeroBanner__content__title">
                  <FormattedMessage
                    ...
                    defaultMessage="Decentralize Your Computing"
                  />
                </div>
              </div>
            </div>
            <div className="HeroBanner__content">
              ...
              <div className="HeroBanner__content__description">
                ...
                <div className="HeroBanner__content__title" style={{ width: '130px' }}>
                  <FormattedMessage id="hero_banner_title_3" defaultMessage="Build a Community" />
                </div>
              </div>
            </div>
          </div>
